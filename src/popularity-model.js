...
export const ACTIVACIONES = [
  ...
  // Animales de casa
  { trigger: 11, targets: [12, 13, 85],         peso: 0.8, motivo: "Cadena perro/animales" },
  { trigger: 12, targets: [11, 13, 85],         peso: 0.75, motivo: "Cadena animales casa" },
  { trigger: 13, targets: [11, 12, 53, 94],     peso: 0.7, motivo: "Animales/transporte" },
  { trigger: 85, targets: [11, 12, 13],         peso: 0.75, motivo: "Cadena animales" },
  // Fiesta
